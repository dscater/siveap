...
const tituloDialog = computed(() => {
    return form.id == 0
        ? `<i class="fa fa-plus"></i> Nueva Contingencia`
        : `<i class="fa fa-edit"></i> Editar Contingencia`;
});
...
const enviarFormulario = () => {
    ...
    let url =
        form["_method"] == "POST"
            ? route("enfermedad_contingencias.store")
            : route("enfermedad_contingencias.update", form.id);
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mt-2">
                        <label class="required"
                            >Descripción de Contingencia</label
                        >
                        <div>
                            <QuillEditor
