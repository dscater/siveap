...
const listCasoEpidemiologicos = ref([]);
...
const cargarCasosEpidemiologicos = () => {
    axios.get(route("caso_epidemiologicos.listado")).then((response) => {
        listCasoEpidemiologicos.value = response.data.caso_epidemiologicos;
        listCasoEpidemiologicos.value.unshift({
            id: "todos",
            codigo: "TODOS",
        });
    });
...
const generarReporte = () => {
    ...
    const url = route("reportes.r_seguimientos", form.value);
...
<template>
    <Head title="Reporte Seguimiento por Casos"></Head>
    <Content>
        <template #header>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Seguimiento por Casos</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active">
                            Reportes - Seguimiento por Casos
                        </li>
                    </ol>
                </div>
                <!-- /.col -->
                    ...
                    <div class="card-body">
                        <form @submit.prevent="generarReporte">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label
                                        >Seleccionar Caso Epidemiológico*</label
                                    >
                                    <el-select
                                    ...
                                    >
                                        <el-option
                                            v-for="item in listCasoEpidemiologicos"
                                            :key="item.id"
                                            :value="item.id"
                                            :label="item.codigo"
                                        >
                                ...
                                <div
                                    class="col-12"
                                    v-if="
                                        form.caso_epidemiologico_id == 'todos'
                                    "
                                >
