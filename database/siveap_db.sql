...
-- Tiempo de generación: 22-06-2026 a las 19:02:46
...
CREATE TABLE `caso_epidemiologicos` (
  ...
  `comunidad_id` bigint UNSIGNED NOT NULL,
  `red_salud` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `captado` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `captado_desc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_id` bigint UNSIGNED NOT NULL,
  `pais_lpi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `departamento_lpi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `municipio_lpi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comunidad_id_lpi` bigint DEFAULT NULL,
  `zona_lpi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pais_lis` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `departamento_lis` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `municipio_lis` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comunidad_id_lis` bigint DEFAULT NULL,
  `zona_lis` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `embarazada` int DEFAULT NULL,
  `fuma` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tipo_alta` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `establecimiento_uti` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `laboratorio` int NOT NULL,
  `nexo` int NOT NULL,
  `muestra` int NOT NULL,
  `fecha_muestra` date DEFAULT NULL,
  `tipo_muestra` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rt_pcr` int NOT NULL,
  `igm` int NOT NULL,
  `igm_nc` int NOT NULL,
  `igg` int NOT NULL,
  `igg_nc` int NOT NULL,
  `observacion_lab` text COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(28, 11, 4, 'false', '2026-06-22 18:51:59', '2026-06-22 18:51:59'),
(29, 11, 5, 'false', '2026-06-22 18:51:59', '2026-06-22 18:51:59'),
(30, 11, 6, 'false', '2026-06-22 18:51:59', '2026-06-22 18:51:59'),
(31, 11, 7, '', '2026-06-22 18:51:59', '2026-06-22 18:51:59'),
(32, 11, 8, 'false', '2026-06-22 18:51:59', '2026-06-22 18:51:59'),
...
(37, 11, 13, 'false', '2026-06-22 18:51:59', '2026-06-22 18:51:59'),
(38, 11, 14, 'false', '2026-06-22 18:51:59', '2026-06-22 18:51:59'),
...
CREATE TABLE `centros` (
  ...
  `fono_correo` varchar(700) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pacientes` (
  ...
  `apoderado` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comunidad_id` bigint UNSIGNED NOT NULL,
  `fecha_registro` date DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `pacientes` (`id`, `nombre`, `paterno`, `materno`, `sexo`, `ci`, `ci_exp`, `fecha_nac`, `dir`, `latitud`, `longitud`, `fono`, `ocupacion`, `departamento`, `municipio`, `zona`, `apoderado`, `comunidad_id`, `fecha_registro`, `created_at`, `updated_at`) VALUES
(1, 'JUAN', 'MONRROY', 'SOLIZ', 'MASCULINO', '456546654', 'LP', '2000-01-01', 'ASUNTA #3223', '-16.123665761985627', '-67.19748973381918', '67676767', NULL, NULL, NULL, NULL, NULL, 1, '2026-05-25', '2026-05-25 14:29:57', '2026-05-25 14:29:57'),
(2, 'MARIA', 'GONZALES', '', 'FEMENINO', '56565656', 'LP', '2003-01-01', 'ASUNTA #2323', '-16.125283924900813', '-67.19494719477096', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-05-25', '2026-05-25 14:44:57', '2026-05-25 14:44:57'),
(3, 'MAX', 'PONZE', '', 'MASCULINO', '345345', 'CB', '2005-01-01', 'ASUNTA #3232', '-16.122441502163745', '-67.19580530036424', NULL, NULL, NULL, NULL, NULL, NULL, 2, '2026-05-26', '2026-05-26 21:51:52', '2026-05-26 21:51:52'),
(4, 'MARIA', 'MARTINEZ', '', 'FEMENINO', '24234', 'LP', '1970-01-01', 'ASUNTA #$43345', '-16.125102', '-67.196268', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-05-26', '2026-05-26 21:54:08', '2026-05-26 21:54:08'),
(5, 'SANDRA', 'CACERES', '', 'FEMENINO', '54645645', 'CB', '2000-01-01', 'ASUNTA #2323', '-16.125102', '-67.196268', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-05-29', '2026-05-29 20:16:57', '2026-05-29 20:16:57'),
(6, 'JUAN', 'GONZALES', '', 'FEMENINO', '123123', 'LP', '2000-01-01', 'LOSOLIVOS #2323', '-16.125102', '-67.196268', NULL, NULL, NULL, NULL, NULL, NULL, 2, '2026-05-30', '2026-05-30 20:19:21', '2026-05-30 20:19:34'),
(7, 'JOSE', 'MARTINEZ', '', 'MASCULINO', '1323131', 'LP', '2012-01-01', 'LOS PEDREGALES', '-16.127017450889603', '-67.19455151824543', '67676767', 'ESTUDIANTE', 'LA PAZ', 'ASUNTA', 'ZONA', 'JUAN MARTINEZ', 1, '2026-06-22', '2026-06-22 13:52:13', '2026-06-22 18:43:37');
