...
class EnfermedadContingenciaUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "enfermedad_id" => "required|unique:enfermedad_contingencias,enfermedad_id," . $this->enfermedad_contingencia->id,
